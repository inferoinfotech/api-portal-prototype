  ...
  if (!catalog?.openapiSpec) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
        ...
        <p className="text-gray-500">This catalog does not contain an OpenAPI (Swagger) file.</p>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      <header className="border-b bg-white/80 backdrop-blur-sm sticky top-0 z-40">
        <div className="container mx-auto px-6 py-4 flex items-center space-x-3">
          ...
          <div
            className="w-8 h-8 rounded-lg flex items-center justify-center"
            style={{ backgroundColor: `${catalog?.color || '#6366f1'}20` }}
          />
          <h1 className="text-xl font-bold">{catalog?.name}</h1>
        </div>
      </header>
